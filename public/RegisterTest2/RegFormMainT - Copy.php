...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="formOne">
            ...
            <form id="form1" name="form1" method="post" action="indexRegisterOldStudent.php" onsubmit="return courseDate()  &&  validateName() && birthDay()  && Gender() && validateEmail() && nic(nic2) && valiDateAddress() && valiDateMotherTounge() &&  validatePhone(phone) && validateFax(fax) &&  helth() && discipline() " >

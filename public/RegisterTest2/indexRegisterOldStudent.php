...
<body>
	...
	<div>  <!-- navigation bar -->
		<ul class="nav nav-tabs">
			<li role="presentation" ><a href="../admin/index.php">Home</a></li>
			<li role="presentation" class="dropdown active">
				...
				<ul class="dropdown-menu">
					<li><a href="../RegisterTest2/indexRegFormNewStudent.php">New Students</a></li>
                                        <li><a href="../RegisterTest2/indexRegisterOldStudent.php" active >Old Students</a></li>
			...
			<div class="panel-body">
				...
				<div class="panel-body">
					...
					<div class="list-group">
						...
						<a href="../RegisterTest2/indexRegFormNewStudent.php" class="list-group-item">New Students</a>
						<a href="../RegisterTest2/indexRegisterOldStudent.php"  class="list-group-item active">Old Students</a>
						<a href="../RegisterTest2/indexRegisteeTeen.php"  class="list-group-item">Children/Teen</a>
                                                <a href="../RegisterTest2/indexRegFormInstroctor.php" class="list-group-item">Instructores</a>
					</div>
				</div>
 ...
 <!-- ================================================================================================================== -->            
		...
		<div class="col-md-8 col-lg-8 panel panel-default">
		  <div class="panel-body">
            ...
            <?php   include_once ('RegFormMainT.php');  ?>

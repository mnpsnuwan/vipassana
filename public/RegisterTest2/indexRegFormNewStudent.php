		...
		<ul class="nav nav-tabs">
			...
			<li role="presentation" class="dropdown active">
				...
				<ul class="dropdown-menu">
					<li><a href="../RegisterTest2/indexRegFormNewStudent.php" active >New Students</a></li>
			...
			<div class="panel-body">
				...
				<div class="panel-body">
					...
					<div class="list-group">
						...
						<a href="../RegisterTest2/indexRegFormNewStudent.php" class="list-group-item active">New Students</a>
						<a href="../RegisterTest2/indexRegisteeTeen.php" class="list-group-item">Old Students</a>
						<a href="../RegisterTest2/indexRegisterOldStudent.php" class="list-group-item">Children/Teen</a>
 ...
 <!-- ================================================================================================================== -->            
		...
		<div class="col-md-8 col-lg-8 panel panel-default">
		  <div class="panel-body">
            ...
            <?php   include_once ('RegFormNewStudent.php');  ?>

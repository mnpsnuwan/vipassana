			...
			<li role="presentation" class="dropdown active">
				...
				<ul class="dropdown-menu">
					<li><a href="../RegisterTest2/indexRegFormNewStudent.php">New Students</a></li>
                                        ...
                                        <li><a href="../RegisterTest2/indexRegisteeTeen.php" active >Children/Teen</a></li>
			...
			<div class="panel-body">
				...
				<div class="panel-body">
					...
					<div class="list-group">
						...
						<a href="../RegisterTest2/indexRegisterOldStudent.php"class="list-group-item ">Old Students</a>
						<a href= "../RegisterTest2/indexRegisteeTeen.php" class="list-group-item active">Children/Teen</a>
 ...
 <!-- ================================================================================================================== -->            
		...
		<div class="col-md-8 col-lg-8 panel panel-default">
		  <div class="panel-body">
            ...
            <?php   include_once ('RegFormTeen.php');  ?>

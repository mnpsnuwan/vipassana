...
if ($session->is_logged_in()) {
	$donated_donor = new Donation();
	$donor_list = $donated_donor->checked_state();
	if (isset($_POST['accept'])) {
		$email=$_POST['email'];
		$donated_donor->update_state(0,$email);
	}
}*/
?>
<!DOCTYPE html>
		...
		<ul class="nav nav-tabs">
				...
				<ul class="dropdown-menu">
					<li><a href="../RegisterTest2/indexRegFormNewStudent.php">New Students</a></li>
                                        ...
                                        <li><a href="../confermRequest/indexConfermRequest.php" >Registration Request</a></li>
				</ul>
			</li>
			...
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-md-12 col-lg-12">
						...
						<div class="col-md-3 col-lg-3"><a href="../updateCourseSchedule/indexUpdateCourseSchedule.php"><img src="../images/course.jpg" alt="ps1" style="height: 180px; width: 180px;"></a>
							<h3>&nbsp;&nbsp; &nbsp;  <span class="label label-primary">Course</span></h3>
						</div>
                                                
                                                
                                                
						<div class="col-md-3 col-lg-3"><a href="../RegisterTest2/indexRegFormNewStudent.php"><img src="../images/registation.jpg" alt="ps2" style="height: 180px; width: 180px;"></a>
							<h3>&nbsp;&nbsp;  <span class="label label-primary">Registration</span></h3>
						</div>
						...
						<div class="col-md-3 col-lg-3"><a href="donation_notification.php"><img src="../images/donation.png" alt="ps3" style="height: 180px; width: 180px;"></a>
							<h3>&nbsp;&nbsp; &nbsp; &nbsp; <span class="label label-primary">Donation</span></h3>
						</div>
						<div class="col-md-3 col-lg-3"><a href="#"><img src="../images/inquery.jpg" alt="ps4" style="height: 180px; width: 180px;"></a>
							<h3>&nbsp;    &nbsp; &nbsp;  <span class="label label-primary">User Inquery</span></h3>
						</div>
					</div>
				</div>
			</div>

<?php
	...
	$request = $donation->view_condition_data();
?>
<!DOCTYPE html>
<html>
<head>
			...
			<div class="panel-body">
				...
				<div class="panel-body">
					...
					<div class="list-group">
						<a href="donation_notification.php" class="list-group-item active">Donation Notification</a>
						<a href="donar_list.php" class="list-group-item">Donar List</a>
						<a href="donar_details.php" class="list-group-item">Donation Details</a>
			...
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-md-12 col-lg-12">
						<div class="well well-sm">New Donation request </div>
					<div class="col-md-8 col-md-offset-1 col-lg-8 col-lg-offset-1">
						<div class="list-group">
							<?php foreach ($request as $key => $value) { ?>
								<a href="./request_view.php?value=<?php echo $value->donar_id; ?>" class="list-group-item"><?php echo $value->items; ?> was doneted.</a>
							<?php } ?>
						</div>
					</div>
					</div>

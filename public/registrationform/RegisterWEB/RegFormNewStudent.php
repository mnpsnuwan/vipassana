...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="formOne">
            <p>&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;<strong class="head1"><span class="fontSize">New Student Registration </span></strong></p>
            
            
            
            
            
            <form id="form1" name="form1" method="post" action="RegFormNewStudent.php" onsubmit="return courseDate() && validateName() && birthDay()  && Gender() && validateEmail() && nic(nic2) && valiDateAddress() && valiDateMotherTounge() &&  validatePhone(phone) && validateFax(fax) &&  helth() && discipline() " >
...
<input id="element_6_2" name="date1" class="element text" size="3" maxlength="2" value="" type="text"> 
 ...
 <!--......................................you have to fill this table...................................-->           
                    ...
                    <tr>
                        <td width="504" height="9"><p><strong>&nbsp;&nbsp; </strong><strong> Name :</strong>

...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="formOne">
            <p>&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong class="head1"><span class="fontSize">Old Student Registration </span></strong></p>
            
            
            
            
            
            <form id="form1" name="form1" method="post" action="RegFormMainT.php" onsubmit="return courseDate()  &&  validateName() && birthDay()  && Gender() && validateEmail() && nic(nic2) && valiDateAddress() && valiDateMotherTounge() &&  validatePhone(phone) && validateFax(fax) &&  helth() && discipline() " >
...
Female&nbsp; <span class="radioRequiredMsg">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Please make a selection.</span></span>	
                    ...
                    <tr>
                        ...
                        <td><p><strong></strong><strong>&nbsp;&nbsp;&nbsp; NIC :</strong> <span class="star">*</span>&nbsp;
...
if (isset($_POST['register'])) {
    ...
    if (!empty($fname) && !empty($nic2) && !empty($email2) && !empty($address1) && !empty($phone) && !empty($motherTounge) && !empty($helth)) {
      ...
      //  $query = $queries->insertQuery($person_detailsAry);
        $queries->Query_connection($queries->insertQuery($person_detailsAry));

...
class Querys {
  ...
  /*****************************this function include insert query**************************************/  
    public static function insertQueryTeen($person_detailsAry) {
    ...
    public static function insertQuery2($person_detailsAry) {
  ...
  /*The mysqli_query() function performs a query against the database.*/  
    ...
    /**************      copy query   registerform  to  confermedapplication  *********************/
       ...
       public static function copyQuery($result){           
 		return "INSERT INTO registerform select * from confermedapplication where RegNo =' ".$result." '" ;
 	} 

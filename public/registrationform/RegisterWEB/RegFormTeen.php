...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	color: #F00;
        ...
        <script src="../SpryAssets/SpryValidationTextarea.js" type="text/javascript"></script><script src="../SpryAssets/SpryValidationRadio.js" type="text/javascript"></script>
    </head>
    ...
    <body>
        ...
        <div class="formOne">
          <p>&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong class="head1"><span class="fontSize">Children Or Teen Registration </span></strong></p>
            <p>&nbsp;</p>
            ...
            <form id="form1" name="form1" method="post" action="RegFormTeen.php" onsubmit="return courseDate()  &&  validateName() && birthDay()  && Gender() && validateEmail() &&  valiDateMotherTounge() &&  validatePhone(phone) && validateFax(fax) &&  helth() && discipline() " >
        ...
        <table width="818"   id="reg_table">
                    ...
                    <tr>
                        <td height="50" colspan="2"><p>&nbsp;<strong> Course Date
                                    :</strong><span>
                                    &nbsp; 
                                    &nbsp; 
                                    &nbsp; 
                                ...
                                <span id="calendar_6">
                                    <img src="./test date/calendar.png" alt="Pick a date." width="37" height="40" class="datepicker" id="cal_img_6">	
                                </span>
 ...
 <!--......................................you have to fill this table...................................-->           
                    ...
                    <tr>
                        <td width="504" height="9"><p><strong>&nbsp; Name :</strong>
                        ...
                        <td width="302" height="15">        
                          <p>
                            ...
                            <input name="lnameA" type="text" id="lnameA" size="23" placeholder="Last Name" />		  
                    ...
                    <tr>
                        ...
                        <td height="76"><strong> &nbsp; Birthday :</strong><span>
...
<label for="element_5_1">MM</label>
                        ...
                        <td><label for="element_2"><strong>Gender</strong></label>
...
Female&nbsp; <span class="radioRequiredMsg">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Please make a selection.</span></span>	
                    ...
                    <tr>
                      <td height="28" colspan="5"><p><strong>&nbsp; </strong></p>
                        <p><strong> &nbsp; Mother Tounge</strong>:<span class="star">*&nbsp;  
                            <input name="motherTounge" type="text" class="textareaFlashState" id="motherTounge" size="15" />
                    ...
                    <tr>
                        <td colspan="2"><p>
                                <label for="job"></label>
                                <strong> &nbsp; School Or Education Level:&nbsp;&nbsp;</strong><span id="sprytextfield12">
                    ...
                    <tr>
                        <td colspan="2"><p><strong> Any physical or mental health problems (if yes please give details/ if pregnant, mention about that) :
                                </strong><span class="star">*</span></p>
                            <p><span id="sprytextarea1">
                               &nbsp;
                               &nbsp; 
                               <textarea name="helth" id="helth" cols="82" rows="2" required></textarea>
                    ...
                    <tr>
                        <td colspan="2"><p><strong> Are you practicing / have been practicing any other form of meditation technique </strong><strong> (if yes please give&nbsp;&nbsp;&nbsp; details)  :</strong></p>
                            <p>
                              <label for="practicing"></label>
                                &nbsp; 
                                &nbsp;<span id="sprytextarea2">
                                    <textarea name="practicing" id="practicing" cols="82" rows="2"></textarea>
                      </span></p></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <label for="agree"><strong>I agree to the Meditation Centre terms of services and privacy policy. <span class="star">*</span></strong></label></td>
                    </tr>
...
<footer>
    ...
    ?>
        ...
        <script type="text/javascript">
            ...
            var sprytextarea2 = new Spry.Widget.ValidationTextarea("sprytextarea2", {validateOn: ["change"], isRequired: false});
...
if (isset($_POST['register'])) {
   ...
   //  $nic1 = trim($_POST['nic1']);                      /*     * *****not db******     */
    ...
    if (!empty($fname) && !empty($email2) && !empty($address1) && !empty($phone) && !empty($motherTounge) && !empty($helth)) {
      ...
      //  $query = $queries->insertQuery($person_detailsAry);
        $queries->Query_connection($queries->insertQueryTeen($person_detailsAry)); 
